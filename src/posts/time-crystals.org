...
To prevent any exponential decay requires both the states to have the same energy i.e. the system must have two ground states. The simplest example is the double-well potential (W-shaped). The "Sombrero" that Akarsh mentioned is a generalization of this.
